...
public class CategoryPanel extends JLabel{
	...
	public CategoryPanel() {
		...
		categoryMenu.setLayout(new GridLayout(2,2,45,30));
		
		
		
		ArrayList<JButton> categoryBt = new ArrayList<JButton>();
		
		categoryBt.add(new JButton("Coffee",CafeDAO.imageScaleChange(new ImageIcon("src/panelDesign/CoffeeCategory.png"), 90, 90)));
		categoryBt.add(new JButton("Ade",CafeDAO.imageScaleChange(new ImageIcon("src/panelDesign/AdeCategory.png"), 90, 90)));
		categoryBt.add(new JButton("Smoothie",CafeDAO.imageScaleChange(new ImageIcon("src/panelDesign/SmoothieCategory.png"), 90, 90)));
		categoryBt.add(new JButton("Tea",CafeDAO.imageScaleChange(new ImageIcon("src/panelDesign/TeaCategory.png"), 90, 90)));
