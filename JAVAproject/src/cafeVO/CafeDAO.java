...
public class CafeDAO {
	...
	private void init() {
		...
		// #1-1 투썸플레이스 종각역점
		list.add(new Cafe("투썸플레이스 종각역점", "서울특별시 종로구 종로 72", new Menu[] {
		...
		// #1-2 투썸플레이스 을지로점
		list.add(new Cafe("투썸플레이스 을지로점", "서울특별시 중구 남대문로10길 30", new Menu[] {
		...
		// #1-3 투썸플레이스 청계천광교점
		list.add(new Cafe("투썸플레이스 청계천광교점", "서울특별시 중구 남대문로 120 대일빌딩 1층", new Menu[] {
		...
		// #1-4 투썸플레이스 종로알파빌딩점
		list.add(new Cafe("투썸플레이스 종로알파빌딩점", "서울특별시 종로구 종로 34 알파빌딩 1층", new Menu[] {
		...
		// #1-5 투썸플레이스 서린동청계광장점
		list.add(new Cafe("투썸플레이스 서린동청계광장점", "서울특별시 종로구 청계천로 17 B1F~3F 투썸플레이스 서린동청계광장점", new Menu[] {
		...
		list.add(new Cafe("힘이나는커피생활 종로젊음의거리점", "서울특별시 종로구 종로12길 15 종로코아빌딩 1층", new Menu[] {
		...
		// 3-2 스타벅스 종로관철점
		list.add(new Cafe("스타벅스 종로관철점", "서울특별시 종로구 종로12길 21", new Menu[] {
		...
		// 3-3 스타벅스 종로R점
		list.add(new Cafe("스타벅스 종로R점", "서울특별시 종로구 종로 51", new Menu[] {
		...
		// #4-1 메가MGC커피 종각역점
		list.add(new Cafe("메가MGC커피 종각역점", "서울특별시 종로구 종로 80-2 1층", new Menu[] {
		...
		// #5-1 빽다방 종로관철점
		list.add(new Cafe("빽다방 종로관철점", "서울특별시 종로구 종로10길 21", new Menu[] {
		...
		// #5-2 빽다방 종로을지로입구역점
		list.add(new Cafe("빽다방 종로을지로입구역점", "서울특별시 중구 남대문로9길 10 1층", new Menu[] {
		...
		// 6. 달콤커피 종로종각점
		list.add(new Cafe("달콤커피 종로종각점", "서울특별시 종로구 종로12길 16 1, 2, 3층", new Menu[] {
		...
		list.add(new Cafe("커피스미스 종로점", "서울특별시 종로구 종로 85 (종로2가)", new Menu[] {
		...
		// 8. 커스텀커피 을지로점
		list.add(new Cafe("커스텀커피 을지로점", "서울특별시 종로구 삼일대로17길 51 1층", new Menu[] {
		...
		// 9. 커피앳웍스 센터원점
		list.add(new Cafe("커피앳웍스 센터원점 ", "서울특별시 중구 을지로5길 26 1층 104호 (미래에셋 센터원빌딩)", new Menu[] {
		...
		list.add(new Cafe("밀크홀 1937 종로점", "서울특별시 종로구 종로 86-1 1층~5층", new Menu[] {
		...
		// #15. (15-1) 일립스커피
		list.add(new Cafe("일립스커피", "서울특별시 종로구 종로9길 8 일립스커피", new Menu[] {
